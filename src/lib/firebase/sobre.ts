...
const DEFAULTS: SobreData = {
  ...
  subheadline: {
    "pt-BR": "A Fábrica de Liberdade é um blog editorial independente sobre inteligência artificial, produtividade e tecnologia — mantido por Anderson Moraes, com o propósito de tornar acessível o que os grandes players já dominam.",
    en: "Freedom Factory is an independent editorial blog about artificial intelligence, productivity, and technology — maintained by Anderson Moraes, with the purpose of making accessible what global players already master.",
    es: "Fábrica de Libertad es un blog editorial independiente sobre inteligencia artificial, productividad y tecnología — mantenido por Anderson Moraes, con el propósito de hacer accesible lo que los grandes actores ya dominan.",
  },
  story: {
    "pt-BR": "A Fábrica de Liberdade nasceu da observação de que as ferramentas de IA e produtividade que estão transformando empresas inteiras ainda parecem inacessíveis para a maioria das pessoas.\n\nFundado em 2025 por Anderson Moraes, este é um blog editorial independente, mantido individualmente, sem patrocinadores fixos. Cada artigo passa por curadoria e revisão antes de ser publicado, e os reviews são baseados em testes reais das ferramentas analisadas.\n\nO conteúdo é publicado em português, inglês e espanhol para alcançar leitores no mundo lusófono e hispânico que querem aprender, na prática, a usar tecnologia para ganhar tempo e criar novas oportunidades.",
    en: "Freedom Factory was born from the observation that AI and productivity tools transforming entire industries still feel inaccessible to most people.\n\nFounded in 2025 by Anderson Moraes, this is an independent editorial blog, individually maintained, with no fixed sponsors. Every article goes through curation and review before publication, and reviews are based on real tests of the tools analyzed.\n\nContent is published in Portuguese, English, and Spanish to reach readers in the Lusophone and Hispanic world who want to learn, in practice, how to use technology to gain time and create new opportunities.",
    es: "Fábrica de Libertad nació de la observación de que las herramientas de IA y productividad que están transformando industrias enteras siguen siendo inaccesibles para la mayoría de las personas.\n\nFundado en 2025 por Anderson Moraes, este es un blog editorial independiente, mantenido individualmente, sin patrocinadores fijos. Cada artículo pasa por curaduría y revisión antes de publicarse, y los reviews se basan en pruebas reales de las herramientas analizadas.\n\nEl contenido se publica en portugués, inglés y español para llegar a lectores del mundo lusófono e hispánico que quieren aprender, en la práctica, a usar tecnología para ganar tiempo y crear nuevas oportunidades.",
  },
  stats: {
    readers: "",
    articles: "",
